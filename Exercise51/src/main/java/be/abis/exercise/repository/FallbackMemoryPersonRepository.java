...
public class FallbackMemoryPersonRepository implements PersonRepository {
    ...
    public FallbackMemoryPersonRepository()  {
        ...
        Person p1 = new Person(1,"John","Doe", DateUtils.parse("21/6/1987"),"jdoe@abis.be","def456", "nl",c1);
        Person p2 = new Person(2,"Mary","Jones",DateUtils.parse("9/5/1998"),"mjones@abis.be","abc123", "fr",c1);
        Person p3 = new Person(3,"Bob","Smith",DateUtils.parse("12/10/1969"),"bob.smith@oracle.com","abc986", "en",c2);
